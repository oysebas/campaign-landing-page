      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-8 md:px-16 lg:px-24 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div 
            ...
            className="reveal-on-scroll p-6 sm:p-8 rounded-card bg-card-bg border border-white/5 flex flex-col justify-between transition-colors duration-300 hover:border-accent-blue/20 group relative cursor-pointer"
          >
            <div className="transition-transform duration-300 ease-[var(--ease-out-quart)] group-hover:-translate-y-1 will-change-transform flex flex-col justify-between h-full">
              <div>
                {/* Icon */}
              ...
              <div className="w-full bg-dark-canvas border border-white/5 rounded-lg p-4 font-mono text-[10px] space-y-3">
                ...
                <div className="space-y-1.5 text-text-primary">
                  <div className="flex justify-between bg-card-bg/50 p-1.5 rounded border border-white/5 transition-colors duration-200 hover:border-white/10">
          ...
          >
            <div className="transition-transform duration-300 ease-[var(--ease-out-quart)] group-hover:-translate-y-1 will-change-transform flex flex-col justify-between h-full">
              ...
              <div className="w-full bg-dark-canvas border border-white/5 rounded-lg p-4 font-mono text-[10px] space-y-3">
                ...
                <div className="space-y-1.5 text-text-primary">
                  <div className="flex items-center space-x-2 bg-card-bg/50 p-1.5 rounded border border-white/5 transition-colors duration-200 hover:border-white/10">
